    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Control de Precompra</h1>
          <p className="mt-2 text-gray-600">GEH Suites · Price / PriceTravel</p>
        </div>

        {/* Upload Card */}
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Cargar archivo de precompra</h2>

          <div
            className={`border-2 border-dashed rounded-xl p-10 text-center transition-colors cursor-pointer ${
              dragging ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-400 hover:bg-blue-50'
            }`}
          ...
          >
            ...
            {loading ? (
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-blue-600 font-medium">Procesando archivo...</p>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  <p className="text-gray-700 font-medium">Arrastre su archivo aquí</p>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl">
            <h3 className="text-sm font-semibold text-blue-800 mb-2">Formato esperado del archivo:</h3>
